/**
 * @file ccgx_host_sdk_desc.h
 *
 * @brief @{CCGx Host SDK API Reference Guide Introduction.@}
 */
...
#ifndef _CCGX_HOST_SDK_DESC_H_
#define _CCGX_HOST_SDK_DESC_H_
 ...
 * -# Implementation of the Thunderbolt 3 Alternate Mode that allows the USB-C
 *    connection to be used for Thunderbolt, Display and USB functions.
 * -# Implementation of the USB Type-C Connector System Software Interface
 *    Specification version 1.1 which allows an OS to manage the Type-C connectors
 *    associated with the CCGx controllers.
 *
 * The CCGx firmware stack is compliant to the:
 * - USB-PD Specification Revision 3.0
 * - Type-C Specification Revision 1.3
 *
 * This version of the CCGx Firmware Stack supports the CCG6, CCG5C, CCG5, CCG4
 * and CCG3 families and is targeted at implementing USB-PD port controllers for desktops
 * and notebooks.
 *
 * Please refer to the CCGx Power SDK for stack and code examples for implementing
 * power adapters and chargers using the CCG3PA device family.  Please use the CCGx
 * SDK 3.0.2 version for stack and code examples for implementing Type-C video
 * adapters using the CCG3 device family.
 *
 ...
 *
 * - ucsi: The ucsi folder contains the implementation of the USB Type-C
 *   Connector System Software Interface which implements registers and
 *   commands through which the Operating System can manage the Type-C connectors
 *   in the platform.
 *
