 ...
 * @file ccgx_version.h
 *
 * @brief @{This file defines the base firmware stack version for CCGx.@}
 */
...
#ifndef _CCGX_VERSION_H_
#define _CCGX_VERSION_H_
