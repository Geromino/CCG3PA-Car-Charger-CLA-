/**
 * @file ccgx_auto_sdk_desc.h
 *
 * @brief @{CCGx Automotive SDK API Reference Guide Introduction.@}
 */
...
#ifndef _CCGX_AUTO_SDK_DESC_H_
#define _CCGX_AUTO_SDK_DESC_H_
 ...
 * - EZ-PD™ CCG3PA:  Power Delivery Solution for Adapters, Chargers, Automotive Rear Seat Car Charger and Head Unit Applications
 ...
 * -# Support for dynamic load sharing between multiple CCG3PA controllers
 *    in a multi-port system with a common power source.
 *
 ...
 * and is targeted at implementing USB-PD Automotive Rear Seat Car Charger and Head Unit applications.
 *
 * Please refer to the CCGx Host SDK for stack and code examples for implementing
 * USB-PD controller for notebook, desktop and mobile systems.  Please refer to the
 * CCGx Power SDK for stack and code examples for implementing USB-PD controller for
 ...
 *   using the Serial Controller Blocks (SCB) on the CCGx device. This module
 *   is used to implement the communication channel between multiple CCG3PA
 *   devices for load balancing.
 *
 * - autoss: This folder provides implementation for the load sharing between
 *   multiple CCG3PA controllers and the handling of system level power supply
 *   and temperature variations. These features are targeted specifically for
 *   USB-PD charging applications in the automotive space.
 *
