/*******************************************************************************
 * File Name: ccg4_regs.h
 *
 * Version: M0S8-Product-CCG4.xls
 *
 * Description:
 ...
 ******************************************************************************/
#ifndef _CCG4_REGS_H_
#define _CCG4_REGS_H_
...
typedef struct {
    ...
    volatile uint32_t rsrvd4[16215];
...
/*
 * The location of the extended data field in the Header.
...
/*
 * This status bit shows the RX Data comparator output from s8usbpd_cc_top.
 */
#define PDSS_STATUS_CC_RX_DATA                              (1u << 19) /* <19:19> RW:R:0: */
...
/*
 * When DELAY_AUTO is set, setting this bit causes HW to set duty cycle at
 * half its calculated value.
 */
#define PDSS_RX_CC_DELAY_HALF                               (1u << 14) /* <14:14> R:RW:0: */


/*
 * When DELAY_AUTO is zero, this bit specifies the number of clock rx_data
 * should be stretched. Clock used is RX sampling clock. The direction of
 * stretch is specified by
 */
...
/*
 * When DELAY_AUTO is zero, CPU can specify duty cycle correction. This bit
 * when set, directs RTL to stretch rx cc data when it is high. When it is
 * zero, then cc_rx_data is stretched when it is low.
 */
#define PDSS_RX_CC_DELAY_WIDEN_HIGH                         (1u << 19) /* <19:19> R:RW:0: */


/*
 * When set, enables automatic duty cycle correction by HW
 */
...
/*
 * This is a debug feature. It defines minimum pulse value. If a pulse for
 * current packet is calculated to be smaller than this value, an interrupt
 * will be issued.  MIN_PULSE_VIOLATED will be set.  This check will be made
...
/*
 * 59:  CHUNK_DET_DONE
 * 58:  TX_SRAM_UNDER_FLOW_DONE
 * 57:  RX_SRAM_OVER_FLOW_DONE
 * 56:  SPARE5
 * 55:  SPARE4
 * 54:  SPARE3
 * 53:  EXTENDED_MSG_DET
 * 52:  HPDT_COMMAND_DONE
 * 51: HPD_QUEUE_DONE
 * 50:  HPD_UNSTABLE
 * 49:  HPD_UNPLUGED
 * 48:  HPD_PLUGED
 * 47:  HPD_IRQ
 * 46:  UI_CAL_DONE
 * 45: PULSE_MIN_VIOLATED_DONE
 * 44: PULSE_MAX_VIOLATED_DONE
 * 43: SPARE7_DONE
 * 42: SPARE6_DONE
 * 41:  HPDIN_CHANGED_DONE
 * 40:  CMP_OUT2_CHANGED_DONE
 * 39:  CMP_OUT1_CHANGED_DONE
 * 38:  V5V_CHANGED_DONE
 * 37:  VCMP_DN_CHANGED_DONE
 * 36:  VCMP_UP_CHANGED_DONE
 * 35:  VCMP_LA_CHANGED_DONE
 * 34:  CC2_CHANGED_DONE
 * 33:  CC1_CHANGED_DONE
 * 32:  VCONN2_CHANGED_DONE
 * 31:  VCONN1_CHANGED_DONE
 * 30:  CMP_OUT2_DET_DONE
 * 29:  SAR2_DONE
 * 28:  RX_STATE_IDLE_DONE
 * 27:  TX_STATE_IDLE_DONE
 * 26:  TX_REGULATOR_ENABLED_DONE
 * 25:  TX_CC_DATA_OEN_DEASSERT_DONE
 * 24:  TX_CC_DATA_OEN_ASSERT_DONE
 * 23:  KCHAR_ERROR_DONE
 * 22:  TX_RETRY_ENABLE_CLRD_DONE
 * 21:  RX_SRAM_HALF_END_DONE
 * 20:  TX_SRAM_HALF_END_DONE
 * 19:  CMP_OUT1_DET_DONE
 * 18:  COLLISION_TYPE4_DONE
 * 17:  COLLISION_TYPE3_DONE
 * 16:  COLLISION_TYPE2_DONE
 * 15:  COLLISION_TYPE1_DONE
 * 14:  CRC_RX_TIMER_EXP_DONE
 * 13:  CC_NO_VALID_DATA_DETECTED_DONE
 * 12:  CC_VALID_DATA_DETECTED_DONE
 * 11:  TX_GOODCRC_MSG_DONE
 * 10:  SAR1_DONE_DONE
 * 9:  RCV_RST_DONE
 * 8:  TX_HARD_RST_DONE_DONE
 * 7:  TX_PACKET_DONE_DONE
 * 6:  RX_OVER_RUN_DONE
 * 5:  EOP_ERROR_DONE
 * 4:  RCV_EXPT_GOODCRC_MSG_COMPLETE_DONE
 * 3:  RCV_GOODCRC_MSG_COMPLETE_DONE
 * 2:  RX_SOP_DONE
 * 1:  RCV_BAD_PACKET_COMPLETE_DONE
 * 0:  RCV_GOOD_PACKET_COMPLETE_DONE
 */
#define PDSS_INTR_DDFT_MUX_INTR_DDFT0_SEL_MASK              (0x0000003f) /* <0:5> R:RW:0: */
 ...
 * 0:  RCV_GOOD_PACKET_COMPLETE_DONE
 */
#define PDSS_INTR_DDFT_MUX_INTR_DDFT1_SEL_MASK              (0x00000fc0) /* <6:11> R:RW:0: */
#define PDSS_INTR_DDFT_MUX_INTR_DDFT1_SEL_POS               (6)
 ...
 * 22: cmp_out1
 * 23: cmp_out2
 * 24: collision_src0 (rx_valid & !tx_busy)
 * 25: collision_src1 (CPU collision)
 * 26: collision_src2 (Retry collision)
 * 27: collision_src3 (timer collision)
 * 28: collision_src4 (send RST collision)
 * 29: hpdin_fx_scan
...
/*
 * Edge detect2 positive/negative enable/disable
 */
...
/*
 * Edge detect2 positive/negative enable/disable. For HPD_IN input
 */
 ...
 * Spare1
 */
#define PDSS_DEBUG_CC_0_SPARE1_MASK                         (0xc0000000) /* <30:31> R:RW:0: */
#define PDSS_DEBUG_CC_0_SPARE1_POS                          (30)
 ...
 * Spare2
 */
#define PDSS_DEBUG_CC_1_SPARE2_MASK                         (0x1ffc0000) /* <18:28> R:RW:0: */
#define PDSS_DEBUG_CC_1_SPARE2_POS                          (18)
...
#define PDSS_DEBUG_SPARE_INTR_CFG_DEFAULT                   (0x00000036)
 ...
 * Edge detect2 positive/negative enable/disable.
 */
#define PDSS_DEBUG_SPARE_INTR_CFG_SPARE7_CFG_MASK           (0x00000018) /* <3:4> R:RW:2: */
#define PDSS_DEBUG_SPARE_INTR_CFG_SPARE7_CFG_POS            (3)
 ...
 * 1: Enable 2 cycles of clk_lf filtering
 */
#define PDSS_DEBUG_SPARE_INTR_CFG_SPARE7_FILT_EN            (1u << 5) /* <5:5> R:RW:1: */
...
#define PDSS_CC_CTRL_0_DEFAULT                              (0xb0040000)
 ...
 * Notes:
 * **:  0.2V when in Deep sleep to prevent DUT wakeup due to noise.
 * *A:CMP_LA_VSEL should  be set to 7 for all application (DFP,UPF,AMA, Cable)
 */
#define PDSS_CC_CTRL_0_CMP_LA_VSEL_MASK                     (0x000e0000) /* <17:19> R:RW:2: */
...
#define PDSS_DPSLP_REF_CTRL_DEFAULT                         (0x00000009)
 ...
 * Cable: 0
 */
#define PDSS_DPSLP_REF_CTRL_PD_DPSLP                        (1u << 3) /* <3:3> R:RW:1: */
...
/*
 * S8USBPD Trim Register0 . Production trims stored in flash
 */
...
/*
 * S8USBPD Trim Register1 . Production trims stored in flash
 */
...
/*
 * S8USBPD Trim Register2 . Production trims stored in flash
 */
...
/*
 * S8USBPD C-connector Trim Register6. Production trims stored in flash
 */
...
/*
 * S8USBPD C-connector Trim Register7. Production trims stored in flash
 */
 ...
 * Spare1 Trim
 */
#define PDSS_S8USBPD_TRIM_SPARE1_SPARE1_TRIM_MASK           (0x000000ff) /* <0:7> R:RW:0: */
#define PDSS_S8USBPD_TRIM_SPARE1_SPARE1_TRIM_POS            (0)
