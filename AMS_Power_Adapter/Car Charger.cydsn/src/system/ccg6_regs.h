/*******************************************************************************
 * File Name: ccg6_regs.h
 *
 * Version: M0S8-Product-CCG6.xlsx: 07/20/2018
 *
 * Description:
 ...
 ******************************************************************************/
#ifndef _CCG6_REGS_H_
#define _CCG6_REGS_H_
...
typedef struct {
    volatile uint32_t ctl;                                /* 0x400c0000 */
    volatile uint32_t status;                             /* 0x400c0004 */
    volatile uint32_t cmd;                                /* 0x400c0008 */
    volatile uint32_t rsrvd0[157];
    volatile uint32_t tr_ctl0;                            /* 0x400c0280 */
    volatile uint32_t tr_ctl1;                            /* 0x400c0284 */
    volatile uint32_t tr_result0;                         /* 0x400c0288 */
    volatile uint32_t tr_result1;                         /* 0x400c028c */
    volatile uint32_t tr_cmd;                             /* 0x400c0290 */
    volatile uint32_t rsrvd1[3];
    volatile uint32_t tr_garo_ctl;                        /* 0x400c02a0 */
    volatile uint32_t tr_firo_ctl;                        /* 0x400c02a4 */
    volatile uint32_t rsrvd2[6];
    volatile uint32_t tr_mon_ctl;                         /* 0x400c02c0 */
    volatile uint32_t rsrvd3;
    volatile uint32_t tr_mon_cmd;                         /* 0x400c02c8 */
    volatile uint32_t rsrvd4;
    volatile uint32_t tr_mon_rc_ctl;                      /* 0x400c02d0 */
    volatile uint32_t rsrvd5;
    volatile uint32_t tr_mon_rc_status0;                  /* 0x400c02d8 */
    volatile uint32_t tr_mon_rc_status1;                  /* 0x400c02dc */
    volatile uint32_t tr_mon_ap_ctl;                      /* 0x400c02e0 */
    volatile uint32_t rsrvd6;
    volatile uint32_t tr_mon_ap_status0;                  /* 0x400c02e8 */
    volatile uint32_t tr_mon_ap_status1;                  /* 0x400c02ec */
    volatile uint32_t rsrvd7[308];
    volatile uint32_t intr;                               /* 0x400c07c0 */
    volatile uint32_t intr_set;                           /* 0x400c07c4 */
    volatile uint32_t intr_mask;                          /* 0x400c07c8 */
    volatile uint32_t intr_masked;                        /* 0x400c07cc */
    volatile uint32_t rsrvd8[12];
    volatile uint32_t mem_buff[64];                       /* 0x400c0800 */
    volatile uint32_t rsrvd9[15744];
    volatile uint32_t priv_buf;                           /* 0x400cff00 */
...
#define PDSS_PGDO_PD_ISNK_CFG_DEFAULT                       (0x003eff00)
 ...
 */
#define PDSS_PGDO_PD_ISNK_CFG_VALUE_1_MASK                  (0x003e0000) /* <17:21> R:RW:31:PGDO_ISNK_H_RES_EN */
#define PDSS_PGDO_PD_ISNK_CFG_VALUE_1_POS                   (17)
 ...
 * BYPASS_VSYS_GOOD_ACC : 0 output independent of vsys_good_acc_hv
 ...
 * 001 - 6  uS glitch filter
 * 010 - 10 uS glitch filter
 * 011 - 13 uS glitch filter
 * 100 - 17 uS glitch filter
 * 101 - 20 uS glitch filter
 * 110 - 24 uS glitch filter
 * 111 - 27 uS glitch filter
 *
