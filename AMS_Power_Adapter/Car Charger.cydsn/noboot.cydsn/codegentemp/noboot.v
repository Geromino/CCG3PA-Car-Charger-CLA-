// ======================================================================
// noboot.v generated from TopDesign.cysch
// 07/08/2020 at 15:31
...
// SW_Tx_UART_v1_50(BaudRate=115200, PinAssignmentMethod=1, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=SW_Tx_UART_v1_50, CY_CONFIG_TITLE=SW_Tx_UART, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=SW_Tx_UART, CY_INSTANCE_SHORT_NAME=SW_Tx_UART, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=50, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=SW_Tx_UART, )
module SW_Tx_UART_v1_50_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("19fb5774-f895-42c2-8e2f-84cb054bffbf/52f31aa9-2f0a-497d-9a1f-1424095e13e6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module top ;
	...
	wire [0:0] tmpOE__BUCK_BOOST_EN_C_net;
	wire [0:0] tmpFB_0__BUCK_BOOST_EN_C_net;
	wire [0:0] tmpIO_0__BUCK_BOOST_EN_C_net;
	wire [0:0] tmpINTERRUPT_0__BUCK_BOOST_EN_C_net;
	electrical [0:0] tmpSIOVREF__BUCK_BOOST_EN_C_net;

	cy_psoc3_pins_v1_10
		#(.id("6a3a2a1b-e8f4-4a8a-90b3-dd70832202f8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		BUCK_BOOST_EN_C
		 (.oe(tmpOE__BUCK_BOOST_EN_C_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BUCK_BOOST_EN_C_net[0:0]}),
		  .io({tmpIO_0__BUCK_BOOST_EN_C_net[0:0]}),
		  .siovref(tmpSIOVREF__BUCK_BOOST_EN_C_net),
		  .interrupt({tmpINTERRUPT_0__BUCK_BOOST_EN_C_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BUCK_BOOST_EN_C_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__BUCK_BOOST_EN_A_net;
	wire [0:0] tmpFB_0__BUCK_BOOST_EN_A_net;
	wire [0:0] tmpIO_0__BUCK_BOOST_EN_A_net;
	wire [0:0] tmpINTERRUPT_0__BUCK_BOOST_EN_A_net;
	electrical [0:0] tmpSIOVREF__BUCK_BOOST_EN_A_net;

	cy_psoc3_pins_v1_10
		#(.id("94715bb8-4d51-4828-8946-e5baf72ee30d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		BUCK_BOOST_EN_A
		 (.oe(tmpOE__BUCK_BOOST_EN_A_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BUCK_BOOST_EN_A_net[0:0]}),
		  .io({tmpIO_0__BUCK_BOOST_EN_A_net[0:0]}),
		  .siovref(tmpSIOVREF__BUCK_BOOST_EN_A_net),
		  .interrupt({tmpINTERRUPT_0__BUCK_BOOST_EN_A_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BUCK_BOOST_EN_A_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    TCPWM_P4_v2_10_0 PWM_A (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
	...
	wire [0:0] tmpOE__PWM_OUT_A_net;
	wire [0:0] tmpFB_0__PWM_OUT_A_net;
	wire [0:0] tmpIO_0__PWM_OUT_A_net;
	wire [0:0] tmpINTERRUPT_0__PWM_OUT_A_net;
	electrical [0:0] tmpSIOVREF__PWM_OUT_A_net;

	cy_psoc3_pins_v1_10
		#(.id("ff68e508-ef33-4177-ad6b-b8c8e91b65d3"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PWM_OUT_A
		 (.oe(tmpOE__PWM_OUT_A_net),
		  .y({Net_212}),
		  .fb({tmpFB_0__PWM_OUT_A_net[0:0]}),
		  .io({tmpIO_0__PWM_OUT_A_net[0:0]}),
		  .siovref(tmpSIOVREF__PWM_OUT_A_net),
		  .interrupt({tmpINTERRUPT_0__PWM_OUT_A_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWM_OUT_A_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__TYPE_A_VBUS_EN_net;
	wire [0:0] tmpFB_0__TYPE_A_VBUS_EN_net;
	wire [0:0] tmpIO_0__TYPE_A_VBUS_EN_net;
	wire [0:0] tmpINTERRUPT_0__TYPE_A_VBUS_EN_net;
	electrical [0:0] tmpSIOVREF__TYPE_A_VBUS_EN_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		TYPE_A_VBUS_EN
		 (.oe(tmpOE__TYPE_A_VBUS_EN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__TYPE_A_VBUS_EN_net[0:0]}),
		  .io({tmpIO_0__TYPE_A_VBUS_EN_net[0:0]}),
		  .siovref(tmpSIOVREF__TYPE_A_VBUS_EN_net),
		  .interrupt({tmpINTERRUPT_0__TYPE_A_VBUS_EN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TYPE_A_VBUS_EN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
