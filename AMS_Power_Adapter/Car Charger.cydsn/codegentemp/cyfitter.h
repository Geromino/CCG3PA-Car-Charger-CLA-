...
#define UART_rx__0__HSIOM_MASK 0x0000F000u
#define UART_rx__0__HSIOM_SHIFT 12u
#define UART_rx__0__HSIOM_UART 11u
#define UART_rx__0__HSIOM_UART_RX 11u
...
#define UART_rx__SHIFT 3u
#define UART_SCB__CMD_RESP_CTRL CYREG_SCB1_CMD_RESP_CTRL
#define UART_SCB__CMD_RESP_STATUS CYREG_SCB1_CMD_RESP_STATUS
...
#define UART_SCBCLK__DIV_ID 0x00000002u
#define UART_SCBCLK__DIV_REGISTER CYREG_PERI_DIV_8_CTL2
...
#define UART_tx__0__HSIOM_UART 11u
#define UART_tx__0__HSIOM_UART_TX 11u
...
/* PWM_A */
#define PWM_A_cy_m0s8_tcpwm_1__CC CYREG_TCPWM_CNT0_CC
#define PWM_A_cy_m0s8_tcpwm_1__CC_BUFF CYREG_TCPWM_CNT0_CC_BUFF
#define PWM_A_cy_m0s8_tcpwm_1__COUNTER CYREG_TCPWM_CNT0_COUNTER
#define PWM_A_cy_m0s8_tcpwm_1__CTRL CYREG_TCPWM_CNT0_CTRL
#define PWM_A_cy_m0s8_tcpwm_1__INTR CYREG_TCPWM_CNT0_INTR
#define PWM_A_cy_m0s8_tcpwm_1__INTR_MASK CYREG_TCPWM_CNT0_INTR_MASK
#define PWM_A_cy_m0s8_tcpwm_1__INTR_MASKED CYREG_TCPWM_CNT0_INTR_MASKED
#define PWM_A_cy_m0s8_tcpwm_1__INTR_SET CYREG_TCPWM_CNT0_INTR_SET
#define PWM_A_cy_m0s8_tcpwm_1__PERIOD CYREG_TCPWM_CNT0_PERIOD
#define PWM_A_cy_m0s8_tcpwm_1__PERIOD_BUFF CYREG_TCPWM_CNT0_PERIOD_BUFF
#define PWM_A_cy_m0s8_tcpwm_1__STATUS CYREG_TCPWM_CNT0_STATUS
#define PWM_A_cy_m0s8_tcpwm_1__TCPWM_CMD CYREG_TCPWM_CMD
#define PWM_A_cy_m0s8_tcpwm_1__TCPWM_CMDCAPTURE_MASK 0x01u
#define PWM_A_cy_m0s8_tcpwm_1__TCPWM_CMDCAPTURE_SHIFT 0u
#define PWM_A_cy_m0s8_tcpwm_1__TCPWM_CMDRELOAD_MASK 0x100u
#define PWM_A_cy_m0s8_tcpwm_1__TCPWM_CMDRELOAD_SHIFT 8u
#define PWM_A_cy_m0s8_tcpwm_1__TCPWM_CMDSTART_MASK 0x1000000u
#define PWM_A_cy_m0s8_tcpwm_1__TCPWM_CMDSTART_SHIFT 24u
#define PWM_A_cy_m0s8_tcpwm_1__TCPWM_CMDSTOP_MASK 0x10000u
#define PWM_A_cy_m0s8_tcpwm_1__TCPWM_CMDSTOP_SHIFT 16u
#define PWM_A_cy_m0s8_tcpwm_1__TCPWM_CTRL CYREG_TCPWM_CTRL
#define PWM_A_cy_m0s8_tcpwm_1__TCPWM_CTRL_MASK 0x01u
#define PWM_A_cy_m0s8_tcpwm_1__TCPWM_CTRL_SHIFT 0u
#define PWM_A_cy_m0s8_tcpwm_1__TCPWM_INTR_CAUSE CYREG_TCPWM_INTR_CAUSE
#define PWM_A_cy_m0s8_tcpwm_1__TCPWM_INTR_CAUSE_MASK 0x01u
#define PWM_A_cy_m0s8_tcpwm_1__TCPWM_INTR_CAUSE_SHIFT 0u
#define PWM_A_cy_m0s8_tcpwm_1__TCPWM_NUMBER 0u
#define PWM_A_cy_m0s8_tcpwm_1__TR_CTRL0 CYREG_TCPWM_CNT0_TR_CTRL0
#define PWM_A_cy_m0s8_tcpwm_1__TR_CTRL1 CYREG_TCPWM_CNT0_TR_CTRL1
#define PWM_A_cy_m0s8_tcpwm_1__TR_CTRL2 CYREG_TCPWM_CNT0_TR_CTRL2

/* Clock_2 */
#define Clock_2__CTRL_REGISTER CYREG_PERI_PCLK_CTL2
...
/* PWM_OUT_A */
#define PWM_OUT_A__0__DR CYREG_GPIO_PRT0_DR
#define PWM_OUT_A__0__DR_CLR CYREG_GPIO_PRT0_DR_CLR
#define PWM_OUT_A__0__DR_INV CYREG_GPIO_PRT0_DR_INV
#define PWM_OUT_A__0__DR_SET CYREG_GPIO_PRT0_DR_SET
#define PWM_OUT_A__0__HSIOM CYREG_HSIOM_PORT_SEL0
#define PWM_OUT_A__0__HSIOM_MASK 0x0000000Fu
#define PWM_OUT_A__0__HSIOM_SHIFT 0u
#define PWM_OUT_A__0__INTCFG CYREG_GPIO_PRT0_INTR_CFG
#define PWM_OUT_A__0__INTR CYREG_GPIO_PRT0_INTR
#define PWM_OUT_A__0__INTR_CFG CYREG_GPIO_PRT0_INTR_CFG
#define PWM_OUT_A__0__INTSTAT CYREG_GPIO_PRT0_INTR
#define PWM_OUT_A__0__MASK 0x01u
#define PWM_OUT_A__0__PC CYREG_GPIO_PRT0_PC
#define PWM_OUT_A__0__PC2 CYREG_GPIO_PRT0_PC2
#define PWM_OUT_A__0__PORT 0u
#define PWM_OUT_A__0__PS CYREG_GPIO_PRT0_PS
#define PWM_OUT_A__0__SHIFT 0u
#define PWM_OUT_A__DR CYREG_GPIO_PRT0_DR
#define PWM_OUT_A__DR_CLR CYREG_GPIO_PRT0_DR_CLR
#define PWM_OUT_A__DR_INV CYREG_GPIO_PRT0_DR_INV
#define PWM_OUT_A__DR_SET CYREG_GPIO_PRT0_DR_SET
#define PWM_OUT_A__INTCFG CYREG_GPIO_PRT0_INTR_CFG
#define PWM_OUT_A__INTR CYREG_GPIO_PRT0_INTR
#define PWM_OUT_A__INTR_CFG CYREG_GPIO_PRT0_INTR_CFG
#define PWM_OUT_A__INTSTAT CYREG_GPIO_PRT0_INTR
#define PWM_OUT_A__MASK 0x01u
#define PWM_OUT_A__PC CYREG_GPIO_PRT0_PC
#define PWM_OUT_A__PC2 CYREG_GPIO_PRT0_PC2
#define PWM_OUT_A__PORT 0u
#define PWM_OUT_A__PS CYREG_GPIO_PRT0_PS
#define PWM_OUT_A__SHIFT 0u

/* TYPE_A_VBUS_EN */
#define TYPE_A_VBUS_EN__0__DR CYREG_GPIO_PRT0_DR
#define TYPE_A_VBUS_EN__0__DR_CLR CYREG_GPIO_PRT0_DR_CLR
#define TYPE_A_VBUS_EN__0__DR_INV CYREG_GPIO_PRT0_DR_INV
#define TYPE_A_VBUS_EN__0__DR_SET CYREG_GPIO_PRT0_DR_SET
#define TYPE_A_VBUS_EN__0__HSIOM CYREG_HSIOM_PORT_SEL0
#define TYPE_A_VBUS_EN__0__HSIOM_MASK 0x000000F0u
#define TYPE_A_VBUS_EN__0__HSIOM_SHIFT 4u
#define TYPE_A_VBUS_EN__0__INTCFG CYREG_GPIO_PRT0_INTR_CFG
#define TYPE_A_VBUS_EN__0__INTR CYREG_GPIO_PRT0_INTR
#define TYPE_A_VBUS_EN__0__INTR_CFG CYREG_GPIO_PRT0_INTR_CFG
#define TYPE_A_VBUS_EN__0__INTSTAT CYREG_GPIO_PRT0_INTR
#define TYPE_A_VBUS_EN__0__MASK 0x02u
#define TYPE_A_VBUS_EN__0__PC CYREG_GPIO_PRT0_PC
#define TYPE_A_VBUS_EN__0__PC2 CYREG_GPIO_PRT0_PC2
#define TYPE_A_VBUS_EN__0__PORT 0u
#define TYPE_A_VBUS_EN__0__PS CYREG_GPIO_PRT0_PS
#define TYPE_A_VBUS_EN__0__SHIFT 1u
#define TYPE_A_VBUS_EN__DR CYREG_GPIO_PRT0_DR
#define TYPE_A_VBUS_EN__DR_CLR CYREG_GPIO_PRT0_DR_CLR
#define TYPE_A_VBUS_EN__DR_INV CYREG_GPIO_PRT0_DR_INV
#define TYPE_A_VBUS_EN__DR_SET CYREG_GPIO_PRT0_DR_SET
#define TYPE_A_VBUS_EN__INTCFG CYREG_GPIO_PRT0_INTR_CFG
#define TYPE_A_VBUS_EN__INTR CYREG_GPIO_PRT0_INTR
#define TYPE_A_VBUS_EN__INTR_CFG CYREG_GPIO_PRT0_INTR_CFG
#define TYPE_A_VBUS_EN__INTSTAT CYREG_GPIO_PRT0_INTR
#define TYPE_A_VBUS_EN__MASK 0x02u
#define TYPE_A_VBUS_EN__PC CYREG_GPIO_PRT0_PC
#define TYPE_A_VBUS_EN__PC2 CYREG_GPIO_PRT0_PC2
#define TYPE_A_VBUS_EN__PORT 0u
#define TYPE_A_VBUS_EN__PS CYREG_GPIO_PRT0_PS
#define TYPE_A_VBUS_EN__SHIFT 1u
...
/* PDSS_PORT0_BCH_CLK */
#define PDSS_PORT0_BCH_CLK__DIV_ID 0x00000040u
#define PDSS_PORT0_BCH_CLK__DIV_REGISTER CYREG_PERI_DIV_16_CTL0
#define PDSS_PORT0_BCH_CLK__PA_DIV_ID 0x000000FFu

/* PDSS_PORT0_SAR_CLK */
#define PDSS_PORT0_SAR_CLK__DIV_ID 0x00000003u
#define PDSS_PORT0_SAR_CLK__DIV_REGISTER CYREG_PERI_DIV_8_CTL3
#define PDSS_PORT0_SAR_CLK__PA_DIV_ID 0x000000FFu

/* PDSS_PORT0_ISINK_CLK */
#define PDSS_PORT0_ISINK_CLK__DIV_ID 0x00000080u
#define PDSS_PORT0_ISINK_CLK__DIV_REGISTER CYREG_PERI_DIV_16_5_CTL0
#define PDSS_PORT0_ISINK_CLK__FRAC_MASK 0x000000F8u
#define PDSS_PORT0_ISINK_CLK__PA_DIV_ID 0x000000FFu

/* PDSS_PORTX_REFGEN_CLK */
#define PDSS_PORTX_REFGEN_CLK__DIV_ID 0x00000042u
#define PDSS_PORTX_REFGEN_CLK__DIV_REGISTER CYREG_PERI_DIV_16_CTL2
#define PDSS_PORTX_REFGEN_CLK__PA_DIV_ID 0x000000FFu

/* PDSS_PORT0_FILT_CLK_SEL */
#define PDSS_PORT0_FILT_CLK_SEL__DIV_ID 0x00000043u
#define PDSS_PORT0_FILT_CLK_SEL__DIV_REGISTER CYREG_PERI_DIV_16_CTL3
#define PDSS_PORT0_FILT_CLK_SEL__PA_DIV_ID 0x000000FFu

/* Miscellaneous */
#define CY_PROJECT_NAME "Car Charger"
