 ...
 *
 * @brief @{PSoC Creator interrupt callback definitions.@}
 *
 *******************************************************************************
 *
...
#define CYAPICALLBACKS_H
    ...
    /* Enable callback on hard faults or unexpected exceptions. */
    #define CY_BOOT_INT_DEFAULT_HANDLER_EXCEPTION_ENTRY_CALLBACK
    
    /* Callback to be executed on hard faults or unexpected exceptions.*/
